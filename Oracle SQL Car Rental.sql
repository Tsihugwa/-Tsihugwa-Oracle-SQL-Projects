...
•	the customer’s telephone number.  If a customer does not have a telephone number, then you should display ‘------------‘, i.e. 12 dashes, instead.  Call this column TEL. 
•	the start date of the booking 
•	the end date of the booking calculated using the hire period, call the column 
END_DATE. 
